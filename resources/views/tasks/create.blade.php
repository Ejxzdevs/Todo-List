    ...
    <div id="app" class="container-fluid bg-custom d-flex flex-column ">
        ...
        <div class="container-fluid h-100 w-100 d-flex flex-row bg-custom d-flex justify-content-center p-3">
            <div class="card h-auto w-25 mt-2 p-2 ">
                <form  class="card-body bg-white h-100 w-100 d-flex flex-column gap-2" action="{{ route('tasks.store') }}" method="post">
                    @csrf
                    @method('post')
                    <h3 class="text-center" for="">Title</h3>
                    <input class="form-control" type="text" name="task_name" value="" placeholder="type title:">
                    <h3 class="text-center " for="">Description</h3>
                    <div class="form-floating">
                        <textarea class="form-control " style="height: 100px;" cols="1" rows="10" name="description" id="floatingTextarea"></textarea>
